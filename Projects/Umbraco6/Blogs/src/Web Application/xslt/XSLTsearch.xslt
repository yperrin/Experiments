...
<xsl:stylesheet version="1.0"
  ...
  XSLTsearch.xslt
  ======================================================================
  Copyright 2006-2013 Percipient Studios. All rights reserved.
  MIT License (http://www.opensource.org/licenses/mit-license.php)

  
  Version 3.0.5 - Updated package xml manifest to remove references to ancient 'Runway' starter kit
  ...
  <xsl:variable name="XSLTsearchVersion" select="'3.0.5'"/>
