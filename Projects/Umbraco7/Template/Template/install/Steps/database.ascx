                ...
                <fieldset>
                        ...
                        <div class="container">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <label for="databaseOptionEmbedded">I want to use My *** SQL CE 4, a free, quick-and-simple embedded database</label>
                    ...
                    <div id="database-options">
                            ...
                            <div class="step" id="database-blank-inputs">
                                <div class="container">
                                    ...
                                    <div class="instruction-hold">
                                        ...
                                        <div class="row sql">
                                            <asp:Label ID="Label1" runat="server" AssociatedControlID="DatabaseIntegratedSecurity">Integrated security:</asp:Label>
                        ...
                        <footer class="btn-box installbtn">
                            <div class="t">&nbsp;</div>
                            <asp:LinkButton ID="LinkButton1" runat="server" class="single-tab submit btn-install" OnClick="SaveDbConfig"><span>install</span>    </asp:LinkButton>
                        </footer>
...
<asp:PlaceHolder ID="installing" runat="server" Visible="false">
    ...
    <div class="tab  install-tab" id="datebase-tab">
        ...
        <footer class="btn-box" style="display: none;">
            <div class="t">&nbsp;</div>
            <asp:LinkButton ID="LinkButton2" class="btn-step btn btn-continue" runat="server" OnClick="GotoNextStep"><span>Continue</span></asp:LinkButton>
            <asp:LinkButton ID="LinkButton3" class="btn-step btn btn-back" Style="display: none;" runat="server" OnClick="GotoSettings"><span>Back</span></asp:LinkButton>
        </footer>
    </div>
